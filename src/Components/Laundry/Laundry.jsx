...
import './Laundry.css'; // Import the CSS file for styling
    ...
    <div className='laundry-page'>
      ...
      <div className='laundry'>
        <div className='laundry-left'>
          ...
          <button className='request-service-btn'>Request a Service</button>
        </div>
      ...
      <div className="background-image-section" style={{backgroundImage: `url(${process.env.PUBLIC_URL}/assets/background2.png)`}}>
        ...
        {/* Rectangular Box with Circular Corners */}
        ...
        <button className="request-service-btn">Request for Service</button> {/* Added Button */}
        </div>
      </div>
      </div>
    </div>
