  ...
  const fashiondeals = [
    {
      ...
      image: 'assets/fashion-product-1.png',
      price: 250,
      originalPrice: 300,
      discount: '20% OFF',
      quantity: '1',
  ...
  return (
    <div className="home-page">
      ...
      <div className="new-section">
        <div className="topdeal-section">
          <div className="rating-new-box1">
